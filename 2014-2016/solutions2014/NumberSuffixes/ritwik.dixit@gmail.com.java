...
public class NumberSuffixes {
	...
	private static class Comp implements Comparator<String> {
		...
		public int compare(String o1, String o2) {
			...
			if (Integer.valueOf(o1.substring(ind1)).compareTo(Integer.valueOf(o2.substring(ind2))) == 0) {
				return 1;
			}
			
			//return compares 
			return Integer.valueOf(o1.substring(ind1)).compareTo(Integer.valueOf(o2.substring(ind2)));
		}
