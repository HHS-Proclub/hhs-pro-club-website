...
$results = json_decode(file_get_contents("content/problem-results.new.json"), true);
...
file_put_contents("content/problem-results.new.json", json_encode($results, JSON_PRETTY_PRINT));
