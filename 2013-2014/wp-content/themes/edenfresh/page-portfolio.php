...
<div id="portfolio-page" <?php post_class('row-fluid wpeden-portfolio-4col thumbnails'); ?>>
 
 
<?php 
query_posts('post_type=portfolio&posts_per_page=16&paged='.get_query_var('paged'));
