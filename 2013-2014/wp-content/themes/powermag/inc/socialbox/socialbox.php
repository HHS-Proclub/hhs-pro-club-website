...
if(!class_exists('SocialBox') and !class_exists('SocialBoxWidget')){
	...
	class SocialBox{
		...
		public function addCronSchedule($schedules){
			...
			$schedules['threehourly'] = array(
				'interval' => 10800,
				'display' => __('Every Three Hours', 'powermag')
			);
			return $schedules;
		...
		public function registerAdminStyle(){
			...
			/* register Style */
			wp_register_style(self::SLUG . '-admin', get_template_directory_uri() . '/inc/socialbox/css/socialbox-admin.css');
	...
	class SocialBoxWidget extends WP_Widget{
		...
		public function __construct(){
			...
			/* Create the widget */
			parent::__construct(self::SLUG, 'PowerMag - Social Box', $widgetOpts, $controlOpts);
