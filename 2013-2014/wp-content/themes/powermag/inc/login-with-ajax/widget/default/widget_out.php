...
<a href="/register/" class="btn" id="pm-register-btn" data-toggle="tooltip" data-placement="left" title="Register"><i class="icon-plus-sign"></i> Register</a>
<?php endif; ?>

<a href="#" class="btn" id="pm-login-btn" data-toggle="tooltip" data-placement="bottom" title="Login"><i class="icon-signin"></i> Login</a>
