...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => __('Choose weather to show the parent category of a post or the end category (default) on post entries (e.g on archive pages and on blog style homepage)', 'powermag'),
		'id' => 'pm_parentcat',
		'type' => 'images',
		'std' => 'end',
		"options" => 
...
$options[] = array( 
	...
	$options[] = array(
		...
		'desc' => __('Select weather to use the default sidebar or a third homepage widgetized area', 'powermag'),
		'id' => 'pm_third_sidebar',
		'type' => 'select',
		'std' => '1',
		'options' => array(
...
$options[] = array( 
	...
	$options[] = array(
			...
			'desc' => __('Select which share buttons to display after a post.', 'options_framework_theme'),
			'id' => 'pm_social_share',
...
/*	$options[] = array( 
	...
	$options[] = array(
		...
		$options[] = array(
			'name' => __('MailChimp URL', 'powermag'),
			'desc' => __('<i><strong>Example:</strong>http://yourdomain.us5.list-manage.com/subscribe/post?u=f05988bb168246549b08542d68&id=8acf9edf41</i>', 'powermag'),
