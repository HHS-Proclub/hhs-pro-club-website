...
if ($show_on_front === 'posts' && empty($category_color)) {$category_color = $skin_color; }
...
if ($category_background_image != NULL) {
	...
	';$wp_styles->add_inline_style("example", " #some {inline: styles-here; } ");
}
...
add_action('wp_enqueue_scripts','pm_output_cat_options');