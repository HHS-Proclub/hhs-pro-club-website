	...
	<?php } ?>
		...
		<div id="nav-wrap" class="clearfix">
			<nav role="navigation" class="site-navigation main-navigation">
						...
						<?php wp_nav_menu( array( 'theme_location' => 'primary', 'after' => '<span class="corner"></span>', 'walker' => new Description_Walker ) ); ?>
						
						<?php if (of_get_option('pm_date') ) { //Get current date if enabled ?>
						<div class="date">
							<a href="<?php echo get_day_link('', '', ''); ?>" rel="tooltip" data-original-title="<?php _e('Check out today&#39s posts!','')?>" data-placement="left"><?php echo date_i18n('j F Y', time()); ?></a>
